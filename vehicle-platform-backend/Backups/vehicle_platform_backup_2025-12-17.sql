...
\restrict PInpQxWvg5XmI9ERdgI3fACKISUYMWKtN8tgpLASf7LlD88rvrKj2G7mkG4kxe2
...
6	KDA123X	Toyota	Axio	2015	\N	available	KDA123X	\N	\N	Active	850000	2025-12-16 17:44:19.787594	2
\.
...
COPY public.ownerships (id, car_id, owner_name, acquired_on) FROM stdin;
1	6	John Doe	2018-01-15
2	6	Jane Wanjiku	2021-06-10
\.
...
COPY public.services (id, car_id, service_date, description, service_type, service_center, notes) FROM stdin;
1	1	2021-03-20	Full service including oil change and brake pads	full service	\N	\N
2	6	2024-03-10	Oil change	routine	Toyota Eldoret	No issues
\.
...
SELECT pg_catalog.setval('public.ownerships_id_seq', 2, true);
...
\unrestrict PInpQxWvg5XmI9ERdgI3fACKISUYMWKtN8tgpLASf7LlD88rvrKj2G7mkG4kxe2
